...
Мы в команде активно пользуемся подходом моков как сервисов и уже реализовали несколько десятков подобных решений.
Начиная от простейших (но гордых), поддерживающих 3-4 хендлера, небольшую базу данных и минимальную логику, заканчиваями огромными сервисами, закрывающими потребности в сотнях интеграций с конкретными внешними системами и обеспечивающими качество в ключевых продуктах компании.
Наши сервисы-моки дают возможность ежедневно запускать тысячи стабильных авто-тестов, проверяющих сотни релизов различных микросервисов.
Пользуясь этим опытом мы и пришли к тем выводам которые описаны в данной статье и планируются во второй, практической и технической части


Любой из описанных вариантов мокирования имеет право на жизнь в разных ситуациях, и в различном контексте одно может подойти больше чем другое, все таки все мы находимся в своих обстоятельствах.
