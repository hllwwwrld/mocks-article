...
<br><br>
    ...
    <br><br>
    2. Не ориентированы на конкретные бизнес процессы, поэтому могут быть сложны в настройке и поддержке, из чего вытекает и более сложный код на уровне авто-тестов и более высокий порог входа, как для внедрения, так и для использования.
    <br><br>
